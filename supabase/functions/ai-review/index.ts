...
Отвечай ТОЛЬКО валидным JSON на русском по схеме:
{"tasks":[
  {"title":"<название>","estimate":<часы:number>,"priority":"low|med|high|urgent","assignee":"<имя из команды или null>","start":"YYYY-MM-DD","end":"YYYY-MM-DD","note":"<зачем задача, 1 фраза>","impact":"core|later"}
]}

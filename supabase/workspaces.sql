-- ============================================================
-- WANDO · Multi-tenant Ф1: воркспейсы
-- ✅ ПРИМЕНЕНО (проверено 2026-09-08: таблица workspaces есть, строка
--    main = founder_forever, workspace_id проставлен, team = 4 места в main).
-- Файл держим как источник схемы; повторный прогон безопасен (if not exists).
